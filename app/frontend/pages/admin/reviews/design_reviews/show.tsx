...
import type { DesignReviewDetail } from '@/types'
...
export default function DesignReviewsShow({ review }: { review: DesignReviewDetail; can: { update: boolean } }) {
  return (
    <div>
      <button
      ...
      <h1 className="text-2xl font-semibold tracking-tight mb-1">Design Review #{review.id}</h1>
...
DesignReviewsShow.layout = (page: ReactNode) => <AdminLayout>{page}</AdminLayout>
