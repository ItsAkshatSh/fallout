...
const columns: ColumnDef<ReviewRow>[] = [
  {
    ...
    cell: ({ row }) => (
      <Link
        href={`/admin/reviews/requirements_checks/${row.original.id}`}
...
export default function RequirementsChecksIndex({ reviews, pagy }: { reviews: ReviewRow[]; pagy: PagyProps }) {
  return (
    <div>
      <h1 className="text-2xl font-semibold tracking-tight mb-4">Requirements Check</h1>
