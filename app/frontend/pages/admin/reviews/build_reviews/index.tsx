...
export default function BuildReviewsIndex({ reviews, pagy }: { reviews: ReviewRow[]; pagy: PagyProps }) {
  return (
    <div>
      <h1 className="text-2xl font-semibold tracking-tight mb-4">Build Review</h1>
