...
import type { BuildReviewDetail } from '@/types'
...
export default function BuildReviewsShow({ review }: { review: BuildReviewDetail; can: { update: boolean } }) {
  return (
    <div>
      <button
      ...
      <h1 className="text-2xl font-semibold tracking-tight mb-1">Build Review #{review.id}</h1>
...
BuildReviewsShow.layout = (page: ReactNode) => <AdminLayout>{page}</AdminLayout>
