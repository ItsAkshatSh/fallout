# -*- encoding: utf-8 -*-
# stub: vite_rails 3.0.20 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "changelog_uri" => "https://github.com/ElMassimo/vite_ruby/blob/vite_rails@3.0.20/vite_rails/CHANGELOG.md", "rubygems_mfa_required" => "true", "source_code_uri" => "https://github.com/ElMassimo/vite_ruby/tree/vite_rails@3.0.20/vite_rails" } if s.respond_to? :metadata=
