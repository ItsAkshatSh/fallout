...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<request_store>.freeze, ["~> 1.4"])
  s.add_development_dependency(%q<benchmark>.freeze, ["~> 0.4.0"])
  s.add_development_dependency(%q<bigdecimal>.freeze, ["~> 3.1"])
  s.add_development_dependency(%q<drb>.freeze, ["~> 2.2"])
  s.add_development_dependency(%q<logger>.freeze, ["~> 1.6"])
  s.add_development_dependency(%q<mutex_m>.freeze, ["~> 0.3.0"])
  ...
  s.add_development_dependency(%q<rails-controller-testing>.freeze, ["~> 1.0.5"])
  s.add_development_dependency(%q<rake>.freeze, ["~> 13.0"])
  s.add_development_dependency(%q<rspec-rails>.freeze, ["~> 7.1.1"])
  s.add_development_dependency(%q<rubocop>.freeze, ["~> 1.75"])
  s.add_development_dependency(%q<rubocop-packaging>.freeze, ["~> 0.6.0"])
  s.add_development_dependency(%q<rubocop-performance>.freeze, ["~> 1.24.0"])
  s.add_development_dependency(%q<rubocop-rails>.freeze, ["~> 2.30.3"])
  s.add_development_dependency(%q<rubocop-rake>.freeze, ["~> 0.7.1"])
  s.add_development_dependency(%q<rubocop-rspec>.freeze, ["~> 3.5.0"])
