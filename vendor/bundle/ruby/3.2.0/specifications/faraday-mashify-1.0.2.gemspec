# -*- encoding: utf-8 -*-
# stub: faraday-mashify 1.0.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency(%q<rubocop>.freeze, ["~> 1.74"])
  s.add_development_dependency(%q<rubocop_auto_corrector>.freeze, [">= 0"])
  s.add_development_dependency(%q<rubocop-packaging>.freeze, ["~> 0.6"])
