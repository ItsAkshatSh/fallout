...
function SessionDetailSkeleton() {
  return /* @__PURE__ */ jsxs("div", { style: { padding: spacing.lg }, children: [
    ...
    /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap: spacing.lg, justifyContent: "center" }, children: [
      /* @__PURE__ */ jsx(Skeleton, { width: "45%", height: 64, borderRadius: radii.md }),
      /* @__PURE__ */ jsx(Skeleton, { width: "45%", height: 64, borderRadius: radii.md })
    ] })
  ] });
}
...
${body.slice(0, 500)}`);
  ...
  return /* @__PURE__ */ jsxs("div", { style: { padding: spacing.lg }, children: [
    ...
    sessionInfo && /* @__PURE__ */ jsxs("div", { style: { marginBottom: spacing.lg }, children: [
      /* @__PURE__ */ jsx("div", { style: { fontSize: fontSize.xl, fontWeight: fontWeight.bold, color: colors.text.primary }, children: sessionInfo.name }),
      /* @__PURE__ */ jsx("div", { style: { fontSize: fontSize.xs, color: colors.text.tertiary, marginTop: 2 }, children: new Date(sessionInfo.createdAt).toLocaleDateString(void 0, { month: "short", day: "numeric", year: "numeric" }) })
    ] }),
